...
Die Vorlesung im Modul DevOps hat mir wertvolle Einblicke in moderne Entwicklungs- und Deployment-Prozesse vermittelt. Besonders spannend fand ich die praxisnahe Vermittlung von Continuous Integration und Continuous Deployment (CI/CD) sowie den Umgang mit Container-Technologien wie Docker. Durch die Kombination von theoretischem Wissen und praktischen Übungen konnte ich mein Verständnis für automatisierte Abläufe im Software-Lifecycle erheblich vertiefen. Besonders hilfreich war die Arbeit mit GitHub Actions und Azure, da ich so gelernt habe, wie man Build- und Deployment-Pipelines realistisch umsetzt und automatisiert. Dies wird mir in zukünftigen Projekten sehr nützlich sein, um Entwicklungszyklen zu verkürzen und Fehlerquellen zu minimieren. Insgesamt hat mir das Modul gezeigt, wie wichtig ein gut abgestimmtes DevOps-Setup für effiziente Softwareentwicklung ist und wie moderne Tools diese Prozesse unterstützen können. Für mich persönlich ist das Modul eine wichtige Grundlage für den Einstieg in professionelle DevOps-Praktiken und motiviert mich, dieses Wissen weiter auszubauen.
